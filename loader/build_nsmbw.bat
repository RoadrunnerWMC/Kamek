...
..\Kamek\bin\Debug\net10.0\Kamek kamekLoader.o nsmbw.o -static=0x800046E4 -output-code=loader.bin -output-riiv=loader.xml -valuefile=Code/loader.bin

REM Or to inject directly into a DOL:
REM ..\Kamek\bin\Debug\net10.0\Kamek kamekLoader.o nsmbw.o -static=0x800046E4 -input-dol=nsmbw.dol -output-dol=nsmbw_kamek.dol
